...
command_t command_list[] = {
    ...
    {"read", adc},
    {"read bin", adc_bin},
    {"live bin", adc_live_bin},
    {"stream bin", adc_stream_bin},
    {"stream packed", adc_stream_packed_bin},
    {"dual stream", adc_dual_stream},
    {"four stream", adc_four_stream},
    {"dual short", adc_dual_short_stream},
    {"four short", adc_four_short_stream},
    {"four common", adc_four_common_short_stream},
    {"four muxblank", adc_four_mux_blank_common_short_stream},
    {"four noise", adc_four_noise_short_stream},
    {"mux diagnostic", adc_mux_diagnostic_stream},
};
